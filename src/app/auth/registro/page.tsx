...
export default function RegistroPage() {
    ...
    const [loadingGoogle, setLoadingGoogle] = useState(false); // Added loadingGoogle state
    const supabase = createClient();

    const handleGoogleLogin = async () => { // Added handleGoogleLogin function
    ...
    const handleRegister = async (e: React.FormEvent) => {
        ...
        // Explicitly upsert into perfiles so nombre_completo is always saved
        if (signUpData.user) {
